#!/bin/sh
# Copyright (c) 2017-2021 The Fleet Credits Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the fleetcredits repository."
  exit 1
fi
...
# See https://github.com/fleetcredits/fleetcredits/issues/16064
...
echo 'When compiling fleetcreditsd, run `./configure` in the following way:'
echo
