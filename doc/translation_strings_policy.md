...
This document provides guidelines for internationalization of the Fleet Credits Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Fleet Credits network</source>
        <translation>
            <numerusform>%n active connection to Fleet Credits network</numerusform>
            <numerusform>%n active connections to Fleet Credits network</numerusform>
        </translation>
    </message>
