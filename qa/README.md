...
Every pull request to the fleetcredits repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing fleetcreditsd/fleetcredits-cli
                        (default: ../../src)
...
blocks (25*50=1250 FC) in its wallet.
