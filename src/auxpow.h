...
// Copyright (c) 2009-2014 The Fleet Credits developers
// Copyright (c) 2014-2016 Daniel Kraft
// Distributed under the MIT/X11 software license, see the accompanying
// file license.txt or http://www.opensource.org/licenses/mit-license.php.

#ifndef FLEETCREDITS_AUXPOW_H
#define FLEETCREDITS_AUXPOW_H
...
public:
    CTransactionRef tx;
    uint256 hashBlock;
    // Fleet Credits TODO: Is this used? If not remove. If it is, I don't think it's actually set
