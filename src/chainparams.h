...
#ifndef FLEETCREDITS_CHAINPARAMS_H
#define FLEETCREDITS_CHAINPARAMS_H
 ...
 * Fleet Credits system. There are three: the main network on which people trade goods
...
#endif // FLEETCREDITS_CHAINPARAMS_H
