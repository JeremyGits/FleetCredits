/* src/config/fleetcredits-config.h.  Generated from fleetcredits-config.h.in by configure.  */
/* src/config/fleetcredits-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FLEETCREDITS_CONFIG_H

#define FLEETCREDITS_CONFIG_H

/* Define if building universal (internal helper macro) */
/* #undef AC_APPLE_UNIVERSAL_BUILD */

/* Define this symbol if experimental features are allowed */
/* #undef ALLOW_FLEETCREDITS_EXPERIMENTAL */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Fleet Credits Core, Fleet Credits Core, and Fleet Credits Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Fleet Credits Core, Fleet Credits Core, and Fleet Credits Core"

/* Copyright year */
#define COPYRIGHT_YEAR 2026

/* Date of the current release */
#define CURRENT_RELEASE_DATE "2026-01-01"
...
#define EXPECTED_DAYS_TO_NEXT_RELEASE 365
...
#define PACKAGE_BUGREPORT "https://github.com/fleetcredits/fleetcredits/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fleet Credits Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fleet Credits Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fleetcredits"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://fleetcredits.org/"
