...
// Copyright (c) 2013-2021 The Fleet Credits Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FLEETCREDITS_CRYPTO_SCRYPT_H
#define FLEETCREDITS_CRYPTO_SCRYPT_H
#include <stdlib.h>
#include <stdint.h>

#if defined(HAVE_CONFIG_H)
#include "config/fleetcredits-config.h" // for USE_SSE2
#endif
...
#endif
#endif // FLEETCREDITS_CRYPTO_SCRYPT_H
