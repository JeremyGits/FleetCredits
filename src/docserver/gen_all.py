...
# -*- coding: utf-8 -*-
"""
Fleet Credits Documentation Generator - Complete
...
./fleetcredits-qt</code></pre>
    ...
    },
    {
        ...
        'content': '''            <section class="content-section">
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Class:</strong> <code>CCodeContributionTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>MWEB Required:</strong> No</p>
                    <p><strong>Class:</strong> <code>CCharitableActTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>MWEB Required:</strong> No</p>
                    <p><strong>Class:</strong> <code>CCreativeWorkTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Bonus Level:</strong> LOW to MEDIUM.</p>
                    <p><strong>MWEB Required:</strong> No</p>
                    <p><strong>Class:</strong> <code>CEducationalContentTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Class:</strong> <code>CMentorshipTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Class:</strong> <code>CAIValidationTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Class:</strong> <code>CDataLabelingTransaction</code></p>
                </div>
                ...
                <div class="api-endpoint">
                    ...
                    <p><strong>Class:</strong> <code>CEthicalReviewTransaction</code></p>
                </div>
    ...
    vector<unsigned char> signature;
                ...
                <h2>File Location</h2>
                <p>All contribution types are defined in <code>src/primitives/contribution.h</code> and implemented in <code>src/primitives/contribution.cpp</code>.</p>
            </section>'''
    },
]
