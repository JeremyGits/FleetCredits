...
{
    RenameThread("fleetcredits-http");
...
{
    RenameThread("fleetcredits-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/fleetcredits/fleetcredits/pull/6990)
