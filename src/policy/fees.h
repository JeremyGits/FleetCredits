...
// Copyright (c) 2023 The Fleet Credits Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef FLEETCREDITS_POLICYESTIMATOR_H
#define FLEETCREDITS_POLICYESTIMATOR_H
 ...
 *
 * Rationale: More conservative than Fleet Credits Core's 60% for "half" confidence,
 * but less conservative than the 85% for "normal" confidence, because the
 * Fleet Credits miners have a hightened incentive to not orphan blocks while the
 * impact of not being included in a block is only ~1/10th of Fleet Credits's when
 ...
 *
 * Copied from Fleet Credits Core 0.15-25.0
 */
...
static const double MAX_FEERATE = COIN * 10.0;    //!< 1000,000,000 koinu - equals 10 FC/kb
...
#endif /* FLEETCREDITS_POLICY_FEES_H */
