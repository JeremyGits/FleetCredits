...
// Copyright (c) 2009-2013 The Fleet Credits developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FLEETCREDITS_PRIMITIVES_PUREHEADER_H
#define FLEETCREDITS_PRIMITIVES_PUREHEADER_H
...
public:
    ...
    {
        return nVersion == 1
            // Fleet Credits: We have a random v2 block with no AuxPoW, treat as legacy
            || (nVersion == 2 && GetChainId() == 0);
    }
};

#endif // FLEETCREDITS_PRIMITIVES_PUREHEADER_H
