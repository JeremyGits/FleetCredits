...
#ifndef FLEETCREDITS_QT_FLEETCREDITSGUI_H
#define FLEETCREDITS_QT_FLEETCREDITSGUI_H
...
/**
  Fleet Credits GUI main class. This class represents the main window of the Fleet Credits UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FleetCreditsGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FleetCreditsGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FleetCreditsGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a fleetcredits wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // FLEETCREDITS_QT_FLEETCREDITSGUI_H
