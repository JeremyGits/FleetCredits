...
#ifndef FLEETCREDITS_QT_FLEETCREDITSUNITS_H
#define FLEETCREDITS_QT_FLEETCREDITSUNITS_H
...
/** Fleet Credits unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FleetCreditsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FleetCreditsUnits(QObject *parent);

    /** Fleet Credits units.
      @note Source: https://en.fleetcredits.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBTC,
...
typedef FleetCreditsUnits::Unit FleetCreditsUnit;

// Legacy typedefs removed - use FleetCreditsUnits and FleetCreditsUnit directly

#endif // FLEETCREDITS_QT_FLEETCREDITSUNITS_H
