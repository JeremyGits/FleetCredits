...
void ImportKeysDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ImportKeysDialog *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ImportKeysDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImportKeysDialog::stopExecutor)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImportKeysDialog::*)(CWallet * , CBlockIndex * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImportKeysDialog::rescanWallet)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ImportKeysDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ImportKeysDialog.data,
    qt_meta_data_ImportKeysDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
