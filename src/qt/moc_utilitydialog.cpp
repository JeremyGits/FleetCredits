...
void PaperWalletDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PaperWalletDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PaperWalletDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_PaperWalletDialog.data,
    qt_meta_data_PaperWalletDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
