...
void ModernMainWindow::setupContent()
{
    ...
    // Setup page content
    setupPageContent(m_sendPage, "Send Coins", "📤", "Send FC to other addresses");
    setupPageContent(m_receivePage, "Receive Coins", "📥", "Generate addresses to receive FC");
    ...
    setupPageContent(m_settingsPage, "Settings", "⚙️", "Configure Fleet Credits Core settings");
