...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", FleetCreditsUnits::FC);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();

    // Fleet Credits: No block explorers yet - leave empty for now
    // Users can add their own URLs when explorers are available
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/fleetcredits/fleetcredits/pull/8273
