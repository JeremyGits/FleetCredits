...
#ifndef FLEETCREDITS_QT_SENDCOINSDIALOG_H
#define FLEETCREDITS_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending Fleet Credits */
...
#endif // FLEETCREDITS_QT_SENDCOINSDIALOG_H
