...
WalletFrame::WalletFrame(const PlatformStyle *_platformStyle, FleetCreditsGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
...
bool WalletFrame::addWallet(const QString& name, WalletModel *walletModel)
{
    ...
    walletView->setFleetCreditsGUI(gui);
...
void WalletFrame::gotoMWEBSuitePage()
{
    WalletView *walletView = currentWalletView();
    if (walletView)
        walletView->gotoMWEBSuitePage();
}

void WalletFrame::gotoContributionsPage()
{
    WalletView *walletView = currentWalletView();
    if (walletView)
