    ...
    platformStyle(_platformStyle)
{
    ...
    // Set up new pages when models are available
    // (Will be set in setClientModel/setWalletModel)
}
...
void WalletView::setFleetCreditsGUI(FleetCreditsGUI *gui)
{
    if (gui)
    {
...
void WalletView::gotoMWEBSuitePage()
{
    setCurrentWidget(mwebSuitePage);
}
