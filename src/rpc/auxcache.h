// Copyright (c) 2025 The Fleet Credits Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FLEETCREDITS_RPC_AUXCACHE_H
#define FLEETCREDITS_RPC_AUXCACHE_H
...
#endif // FLEETCREDITS_RPC_AUXCACHE_H
