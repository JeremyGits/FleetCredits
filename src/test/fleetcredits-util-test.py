...
# Copyright 2016 The Fleet Credits Core developers
...
help_text="""Test framework for Fleet Credits utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/fleetcredits-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "fleetcredits-util-test.json", buildenv)
