// Copyright (c) 2012-2015 The Fleet Credits Core developers
...
static const CFleetCreditsAddress addr1 ("DSpgzjPyfQB6ZzeSbMWpaZiTTxGf2oBCs4");
static const CFleetCreditsAddress addr2 ("DR9VqfbWgEHZhNst34KQnABQXpPWXeLAJD");
static const CFleetCreditsAddress addr1C("D8jZ6R8uuyQwiybupiVs3eDCedKdZ5bYV3");
static const CFleetCreditsAddress addr2C("DP7rGcDbpAvMb1dKup981zNt1heWUuVLP7");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CFleetCreditsAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CFleetCreditsSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
