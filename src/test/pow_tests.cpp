// Copyright (c) 2015 The Fleet Credits Core developers
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual)
{
    ...
    pindexLast.nTime = 1279008237 + (239 * 60 / 4 - 1); // Fleet Credits Block #66528 + less than a quarter of the target timespan
    pindexLast.nBits = 0x1c05a3f4;
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, params), 0x1c0168fd);
}

/* Test the constraint on the upper bound for actual time taken */
// Replaced by Fleet Credits-specific PoW test
