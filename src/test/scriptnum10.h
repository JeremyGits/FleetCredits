...
#ifndef FLEETCREDITS_TEST_SCRIPTNUM10_H
#define FLEETCREDITS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fleet Credits Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // FLEETCREDITS_TEST_BIGNUM_H
