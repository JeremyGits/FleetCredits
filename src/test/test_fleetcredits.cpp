...
#define BOOST_TEST_MODULE Fleet Credits Test Suite
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    ...
    if (GetTime() < mock_time) {
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_fleetcredits_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
