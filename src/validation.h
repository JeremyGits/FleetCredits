...
#ifndef FLEETCREDITS_VALIDATION_H
#define FLEETCREDITS_VALIDATION_H
...
/* Fleet Credits: Set the high tx fee to be higher than the default values
...
#endif // FLEETCREDITS_VALIDATION_H
