...
#ifndef FLEETCREDITS_WALLET_WALLET_H
#define FLEETCREDITS_WALLET_WALLET_H
...
/* 1.14.5: set the wallet's discard threshold to 1 FC because that's what 97%
 ...
 */
/* 1.14.6: set the wallet's discard threshold to 0.01 FC. Very network
...
/*
 * Fleet Credits: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Fleet Credits: Creating change outputs at exactly the dustlimit is counter-
...
public:
     ...
     * on this fleetcredits node, and set to 0 for transactions that were created
...
public:
    ...
    /**
     * Fleet Credits: Get a fee targeting a specific transaction speed.
     */
    CAmount GetFleetCreditsPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Fleet Credits: Get a fee targeting a specific transaction speed.
     */
    static CAmount GetFleetCreditsPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Fleet Credits dust fee.
     */
...
#endif // FLEETCREDITS_WALLET_WALLET_H
